...
BROKER_URL = 'amqp://root:123456@localhost:5672//' if DEBUG else 'amqp://root:123456@localhost:5672//'
...
EMAIL_SEND_USERNAME = '1810420645@qq.com'  # 定时任务报告发送邮箱，支持163,qq,sina,企业qq邮箱等，注意需要开通smtp服务
EMAIL_SEND_PASSWORD = 'qhacwnvodwskcbaf'     # 邮箱密码
